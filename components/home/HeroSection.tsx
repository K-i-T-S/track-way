...
const FleetNetworkScene = dynamic(
  () => import("@/components/three/FleetNetworkScene"),
  { ssr: false },
);
        ...
        >
          ...
          {reduceMotion ? (
            <div className="flex h-full w-full items-center justify-center">
              <div className="h-40 w-40 rounded-full border-4 border-accent/30" />
            </div>
          ) : (
            <SceneErrorBoundary
              fallback={
            ...
            >
              <Suspense
                fallback={
                  <div className="flex h-full w-full items-center justify-center">
                    <div className="h-40 w-40 animate-pulse rounded-full border-4 border-accent/30" />
                  </div>
                }
              >
                <FleetNetworkScene />
